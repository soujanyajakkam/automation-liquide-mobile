...
public class LiquideOneTest extends BaseMobileAutomationTest {
	...
	/*	@Test(priority = 2, description = "Verifying Liquide One funtionality using enough Coins")
		@Parameters({ "devicename" })
		@Description("Test Description: Verifying Purchasing Liquide One funtionality using enough Coins")
		@Story("Verifying Purchasing Liquide One")
		public void liquideOneConvertionUsingCoins() throws InterruptedException {
			...
			LiquideOne.clickSwitchPlanButton();
			LiquideOne.clickOnProceed999Button();
			LiquideOne.clickOnUseCoinsButton();
			LiquideOne.clickOnPay0Button();
			LiquideOne.clickExploreButton();
			
            Thread.sleep(4000);
			logger.info("Ending of liquideOneConvertionUsingCoins method");
		}*/
		@Test(priority = 3, description = "Verifying Liquide One funtionality using CouponCode")
		@Parameters({ "devicename" })
		@Description("Test Description: Verifying Purchasing Liquide One funtionality using CouponCode")
		@Story("Verifying Purchasing Liquide One")
		public void liquideOneConvertionUsingCouponCode() throws InterruptedException {
			...
			LiquideOne.clickSwitchPlanButton();
			LiquideOne.clickOnProceed999Button();
			LiquideOne.clickOnApplyCoupon();
			LiquideOne.clickOnCouponCode();
			LiquideOne.clickOnYayThanksButton();
			LiquideOne.clickOnPayButton();
